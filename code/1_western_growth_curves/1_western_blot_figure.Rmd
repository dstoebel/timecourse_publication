...
author: "Josephine Adams & Dan Stoebel"
date: "06/02/2022"
...
##Create a new scale so that instead of 1e-01, I'll get 10^-1 with proper exponentiaion.
# Based on https://stackoverflow.com/questions/10762287/how-can-i-format-axis-labels-with-exponents-with-ggplot2-and-scales
...
ggsave("../../outputs/graphs/1_rpos_OD_levels_plot.tiff", width = 6.875, height = 6.875, dpi = 1200)
```
