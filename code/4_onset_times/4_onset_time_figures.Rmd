...
ggsave("../../outputs/graphs/4_onset_times_conditions.tiff", width = 6.825, height = 5.5, dpi = 300)
```
...
ggsave("../../outputs/graphs/5_onset_times_sensitivity.tiff", width = 6.875, height = 5.5, dpi = 300)
...
ggsave("../../outputs/graphs/6_correlations.tiff", width = 6.825, height = 3.5, dpi = 300)
```
